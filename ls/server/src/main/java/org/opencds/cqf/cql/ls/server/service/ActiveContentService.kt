...
class ActiveContentService : ContentService {
    ...
    protected fun patch(sourceText: String, change: TextDocumentContentChangeEvent): String {
    ...
    protected fun searchActiveContent(root: URI, identifier: VersionedIdentifier): Set<URI> {
