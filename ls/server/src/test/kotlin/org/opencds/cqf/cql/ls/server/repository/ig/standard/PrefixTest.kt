...
class PrefixTest {
    ...
    @Test
    fun searchCondition() {
        val cons = repository.search(
            Bundle::class.java, Condition::class.java, Searches.byCodeAndSystem("12345", "example.com/codesystem")
        )
        assertNotNull(cons)
    ...
    fun createAndDeleteLibrary() {
        ...
        val loc = tempDir!!.resolve("resources/library/Library-new-library.json")
    ...
    fun createAndDeletePatient() {
        ...
        val loc = tempDir!!.resolve("tests/patient/Patient-new-patient.json")
        assertTrue(Files.exists(loc))
    ...
    fun createAndDeleteValueSet() {
        ...
        val loc = tempDir!!.resolve("vocabulary/valueset/ValueSet-new-valueset.json")
        assertTrue(Files.exists(loc))
    ...
    fun resourceMissingWhenCacheCleared() {
        ...
        val path = tempDir!!.resolve("resources/library/Library-ToDelete.json")
