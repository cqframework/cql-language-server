...
fun main(args: Array<String>) {
    ...
    ServiceLoader.load(CqlLanguageServerPluginFactory::class.java).forEach { factory ->
        factory.createPlugin(languageClientFuture, workspaceService, textDocumentService, compilationManager)
            .getCommandContribution()?.let { contributions.add(it) }
    }
